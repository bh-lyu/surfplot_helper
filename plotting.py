...
from wbplot_images import write_parcellated_image # from wb plot images
...
from utils.plot_util import check_vrange
...
def plot_Kong_parcellation(data, figfile,  scene=1, 
    ...
    :scene: 1=with parcel outline, 2=without parcel outline
    :return:
    """
...
def add_title_png(img_file,title, fontname = 'Arial', fontsize=100, title_position=300):
    """
...
def add_colorbar_png(data, img_file, cmap, vrange = None , orientation='horizontal'):
    ...
    draw_colorbar(data, figsize=(6, 0.8), file_colorbar=file_colorbar, cmap=cmap, vrange=vrange, orientation=orientation)
...
def draw_colorbar(data, figsize, file_colorbar, cmap, fontsize=32, vrange=None, orientation='horizontal'):
